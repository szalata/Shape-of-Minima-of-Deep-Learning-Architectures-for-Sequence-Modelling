...
do
    ...
    output_dir="output/seq_cls/fixed_length/$model-model_$len-length_$epochs-epochs_$nlayer-layer_$nhead-head_$nhid-hiddendim"
    ...
    output_dir="output/seq_cls/variable_length/$model-model_$len-length_$epochs-epochs_$nlayer-layer_$nhead-head_$nhid-hiddendim"
...
do
    ...
    output_dir="output/seq_lrn/fixed_length/fixed_inc/$model-model_$len-length_$epochs-epochs_$nlayer-layer_$nhead-head_$nhid-hiddendim"
    ...
    output_dir="output/seq_lrn/fixed_length/var_inc/$model-model_$len-length_$epochs-epochs_$nlayer-layer_$nhead-head_$nhid-hiddendim"
    ...
    output_dir="output/seq_lrn/variable_length/fixed_inc/$model-model_$len-length_$epochs-epochs_$nlayer-layer_$nhead-head_$nhid-hiddendim"
    ...
    output_dir="output/seq_lrn/variable_length/var_inc/$model-model_$len-length_$epochs-epochs_$nlayer-layer_$nhead-head_$nhid-hiddendim"
